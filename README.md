...
A FFVI inspired StreamElements custom widget for tracking number of blesses, curses, or blurses redeemed for a speedrun.
...
- In the left side-bar, click on 'Settings'
